...
<div class="pop-wrap food_order">
<h1 class="head"><?php echo Yii::t("default","Add item to cart")?></h1>
<div class="pop-inner"> 
<?php if ($food_item=yii::app()->functions->getFoodItemDetails($_GET['item-id'])): ?> 
  ...
  <div class="left item_description">
    ...
    <?php 
    /*ADD META TAGS*/
    /*$title=yii::app()->functions->getOption('store_name')." - ".$food_item[0]['item_name'];
