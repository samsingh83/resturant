...
class Paypal
{
	...
	{
		$this->params['USER']=$this->config[$this->mode]['user'];
		$this->params['PWD']=$this->config[$this->mode]['psw'];
		$this->params['SIGNATURE']=$this->config[$this->mode]['signature'];
		$this->params['VERSION']=$this->config[$this->mode]['version'];		
	}
