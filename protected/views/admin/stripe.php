<?php
$enabled=Yii::app()->functions->getOption('admin_stripe_enabled');
$paymode=Yii::app()->functions->getOption('admin_stripe_mode');
?>
...
<div class="uk-form-row">
  ...
  Yii::app()->functions->getOption('admin_sanbox_stripe_secret_key')
  ,array(
...
<div class="uk-form-row">
  ...
  Yii::app()->functions->getOption('admin_sandbox_stripe_pub_key')
  ,array(
    'class'=>"uk-form-width-large"
  ))
  ?>
...
<div class="uk-form-row">
  ...
  Yii::app()->functions->getOption('admin_live_stripe_secret_key')
  ,array(
    'class'=>"uk-form-width-large"
  ))
  ?>
...
<div class="uk-form-row">
  ...
  Yii::app()->functions->getOption('admin_live_stripe_pub_key')
  ,array(
    'class'=>"uk-form-width-large"
  ))
  ?>
