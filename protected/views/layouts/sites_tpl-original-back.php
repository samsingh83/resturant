...
<body class="layout_themes<?php echo Yii::app()->functions->getOption("layout_themes"); ?> full_layout<?php echo Yii::app()->functions->getOption("full_layout"); ?>">
	...
	<div class="main">	
		...
		<div class="right top_nav">
		  <div class="<?php echo Yii::app()->functions->getOption("allowed_ordering")==2?"first_menub":"first_menu";?>">		    
		    ...
		    <?php else :?>
            <li><a href="javascript:;" data-toggle="modal" data-target=".pop_login"><i class="fa fa-sign-in"></i> <?php echo Yii::t('default',"Login & Signup")?></a></li>		  
